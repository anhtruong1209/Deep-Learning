...
architecture_config = [
    # (kerel_size, nums_filter ouput, stride, padding) (tupple)
    # M is Maxpooling (str)
    (7, 64, 2, 3),
    "M",
    (3, 192, 1, 1),
    ...
    (3, 512, 1, 1),
    "M",
    # List : tuples and then last integer represents nummber of repeats
    [(1, 256, 1, 0), (3, 512, 1, 1), 4], #(conv1, conv2, num_repeates)
    (1, 512, 1, 0),
    (3, 1024, 1, 1),
    "M",
